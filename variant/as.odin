...
AS_NUOOBECT_PTR1 :: #force_inline proc "contextless" (value: ^Value) -> ^NuoObject { return REINTERPRET_MEM(value,^NuoObject) }

AS_NUOOBECT_PTR2 :: #force_inline proc "contextless" (value: ^Value, $T: typeid) -> ^T { return reinterpret_object(REINTERPRET_MEM(value,^NuoObject),T) }
