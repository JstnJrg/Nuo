...
{ 
	util.init_arena(get_compiler_arena(),.Growing);
	util.init_arena(get_compiler_ast_arena(),.Growing);
}
init_runtime_arena  :: proc() { util.init_arena(get_runtime_arena(),.Growing)  }
...
compiler_arena_destroy     :: proc() { util.deinit_arena(get_compiler_arena()); util.deinit_arena(get_compiler_ast_arena()) }
