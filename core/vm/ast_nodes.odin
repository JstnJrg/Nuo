...
create_int_node :: proc(number: Int ,loc: Localization) -> ^IntNode{
...
create_float_node :: proc(number: Float ,loc: Localization) -> ^FloatNode{
...
create_string_node :: proc(data: string ,loc: Localization) -> ^StringNode{
...
create_class_node :: proc(cname: string,extends: bool, super,container: ^Node, loc : Localization) -> ^ClassNode
{
