...
MAX_FIELDS          :: util.MAX_FIELDS
MAX_FRAMES          :: util.MAX_FRAMES


CLASS_PROPERTIES    :: variant.CLASS_PROPERTIES
...
BoundMethod        :: variant.BoundMethod
SafeMethod         :: variant.SafeMethod
NuoCallable        :: variant.NuoCallable
...
safe_check_args       :: variant.safe_check_args
...
import_get_init_fn          :: variant.import_get_init_fn
import_db_was_loaded        :: variant.import_db_was_loaded
import_db_set_loaded        :: variant.import_db_set_loaded
...
class_register_property         :: variant.class_register_property
class_db_default_setter			:: variant.class_db_default_setter
class_db_default_getter			:: variant.class_db_default_getter
...
IS_CALLABLE_PTR :: variant.IS_CALLABLE_PTR
...
create_obj_task      :: variant.create_obj_task
...
gc_iterate_frees :: variant.gc_iterate_frees
